...
const approveIdCardStatus = async (req, res) => {
  try {
    ...
    // Generate unique iinsafId
    const iinsafId = await generateUniqueIinsafId();
    ...
    if (updatedCard.mobileNo) {
      await notifyOnWhatsapp(
        ...
        Templates.AFTER_ID_CARD_APPROVED_NOTIFY_TO_REPORTER, // "admin approved ID"
        [
