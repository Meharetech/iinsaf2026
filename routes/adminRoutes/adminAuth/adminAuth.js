...
const {getAllPayments, adminGetReportersWithdrawlHistory} = require("../../../controller/admin/ToatalEarning/Revenue")
...
router.get("/super/admin/subadmin/:id", adminAuthenticate, isSuperAdmin, getSubAdminById);

// ✅ Update subadmin details
router.put("/super/admin/subadmin/:id", adminAuthenticate, isSuperAdmin, updateSubAdmin);
