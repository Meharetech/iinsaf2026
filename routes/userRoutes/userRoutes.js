...
const {preRegisterUser , verifyOtp} = require('../../controller/user/registerUser')
...
const {forgetPassword, resendOtp, verifyOtpAndResetPassword, setNewPassword, verifyOldPassword, updatePassword} = require("../../controller/user/forgetPassword")
